              ...
              <Grid item key={product.id} xs={6} sm={4} md={4} lg={2}>
                <Card className="card">
                  ...
                  >
                    ...
                    <Typography variant="body2" color="text.secondary" sx={{ color: '#333333', fontWeight: 500, lineHeight: '17px', fontSize: '12.66px' }}>
                      Yorum
                    </Typography>
                    <Typography variant="h6" component="div" sx={{ color: '#000000', fontWeight: 400, lineHeight: '32px', fontSize: '19.69px' }}>
